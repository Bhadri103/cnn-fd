...
const BioDataField = ({ label, value }) => {
    ...
    return (
        <div style={rowStyle}>
            <div style={{ width: '45%', ...labelStyle }}>{label}</div>
            ...
            <Row className="justify-content-center">
                <Col md={10} lg={8}>
                    <Card className="shadow-sm">
                        <CardBody>
                            <div ref={pdfRef} style={{ border: '2px solid #2E8B57', padding: '15px', backgroundColor: '#F8F9FA' }}>
                                {/* Header Section */}
                                <div style={{ textAlign: 'center', marginBottom: '15px', borderBottom: '1px solid #ccc', paddingBottom: '10px' }}>
                                    <h4 style={{ color: '#2E8B57', marginBottom: '5px' }}>Bio Data</h4>
                                ...
                                <Row>
                                    ...
                                    <Col md={8}>
                                        ...
                                        <BioDataSection>
                                         ...
                                         <BioDataSection>
                                             ...
                                             {/* Family Table */}
                                             <Table bordered size="sm" responsive className="mt-2" style={{ fontSize: '0.85rem' }}>
                                                 <thead>
                                                 ...
                                                 <tbody>
                                                     <tr>
                                                         <td>Married</td>
                                                         <td>{dummyUser.brother_elder > 0 && dummyUser.brother_married >= dummyUser.brother_elder ? dummyUser.brother_elder : '-'}</td>
                                                          <td>{dummyUser.brother_younger > 0 && (dummyUser.brother_married - dummyUser.brother_elder) >= dummyUser.brother_younger ? dummyUser.brother_younger : '-'}</td>
                                                         <td>{dummyUser.sister_elder > 0 && dummyUser.sister_married >= dummyUser.sister_elder ? dummyUser.sister_elder : '-'}</td>
                                                         <td>{dummyUser.sister_younger > 0 && (dummyUser.sister_married - dummyUser.sister_elder) >= dummyUser.sister_younger ? dummyUser.sister_younger : '1'}</td>
                                                     </tr>
                                                      <tr>
                                                         <td>Unmarried</td>
                                                          <td>{dummyUser.brother_elder > 0 && dummyUser.brother_married < dummyUser.brother_elder ? dummyUser.brother_elder - dummyUser.brother_married : '-'}</td>
                                                          <td>{dummyUser.brother_younger > 0 && (dummyUser.brother_married - dummyUser.brother_elder) < dummyUser.brother_younger ? dummyUser.brother_younger - Math.max(0, dummyUser.brother_married - dummyUser.brother_elder) : '-'}</td>
                                                          <td>{dummyUser.sister_elder > 0 && dummyUser.sister_married < dummyUser.sister_elder ? dummyUser.sister_elder - dummyUser.sister_married : '-'}</td>
                                                          <td>{dummyUser.sister_younger > 0 && (dummyUser.sister_married - dummyUser.sister_elder) < dummyUser.sister_younger ? dummyUser.sister_younger - Math.max(0, dummyUser.sister_married - dummyUser.sister_elder) : '-'}</td>
                                                     </tr>
                                                 </tbody>
                                             </Table>
                                    ...
                                    <Col md={4} className="text-center">
                                        <img
                                            ...
                                            alt="Profile"
                                            className="img-fluid"
                                            style={{ border: '1px solid #ccc', padding: '3px', maxHeight: '200px', objectFit: 'contain' }}
                                            onError={(e) => { e.target.onerror = null; e.target.src = profilePlaceholder; }} // Fallback placeholder
                                        />
                                    </Col>
                                </Row>
                                 ...
                                 <div style={{ borderTop: '1px solid #ccc', paddingTop: '10px', marginTop: '15px' }}>
                                     <h5 style={{ color: '#2E8B57', marginBottom: '10px' }}>Life Partner Expectations ( வாழ்க்கை துணை பற்றிய எதிர்பார்ப்பு )</h5>
                                     <Row>
                                 ...
                                 <div style={{ borderTop: '1px solid #ccc', paddingTop: '10px', marginTop: '15px' }}>
                                     <h5 style={{ color: '#2E8B57', marginBottom: '10px' }}>Contact Details</h5>
                                     <Row>
                                 ...
                                 <div style={{ borderTop: '1px solid #ccc', paddingTop: '10px', marginTop: '15px', textAlign: 'center', fontSize: '0.8rem', color: '#777' }}>
